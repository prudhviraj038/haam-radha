...
public class SubCategoryAdapter extends BaseAdapter implements Filterable {
    ...
    public SubCategoryAdapter(Activity mainActivity, Categories categories,MainActivity mCallback) {
...
//        mFirebaseAnalytics = FirebaseAnalytics.getInstance(context);
        chanels = this.categoriess.chanels;
        chanels_all = chanels;
       // this.mCallback = mCallback;
    }

    public SubCategoryAdapter(Activity mainActivity, Categories categories,NewsRecycleListActivity mCallback) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        this.categoriess=categories;
        inflater = ( LayoutInflater )context.
...
//        mFirebaseAnalytics = FirebaseAnalytics.getInstance(context);
    ...
    public class Holder
    {
        ...
        LinearLayout sub_cat_linearlayout;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
            convertView = inflater.inflate(R.layout.sub_category_item, null);
        holder.tv=(TextView) convertView.findViewById(R.id.cat_name);
        ...
        holder.tv.setText(Html.fromHtml(chanels.get(position).ch_title_fr));
            ...
            Log.e("chh_title", chanels.get(position).ch_title_ar);
        }else {
        ...
        holder.follow_btn=(com.mamacgroup.hamtest.MyTextView) convertView.findViewById(R.id.follow_btn);
        ...
        holder.follow_btn_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (db.is_following(chanels.get(position).ch_id)) {
                    ...
                    db.addPlaylist(chanels.get(position).ch_id, categoriess.id,"1");
//                    mFirebaseAnalytics.setUserProperty("favorite_channel", chanels.get(position).get_ch_title(context));
                    add_ch("add", chanels.get(position).ch_id);
