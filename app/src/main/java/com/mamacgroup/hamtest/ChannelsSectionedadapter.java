 ...
 */
public class ChannelsSectionedadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChannelsSectionedadapter(ArrayList<Model> data, Context context) {
        this.dataSet = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case Model.AUDIO_TYPE:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.news_item_ad, parent, false);
