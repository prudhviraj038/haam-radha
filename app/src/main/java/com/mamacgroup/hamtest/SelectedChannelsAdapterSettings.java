...
public class SelectedChannelsAdapterSettings extends BaseAdapter implements Filterable {
    Context context;
    ...
    public SelectedChannelsAdapterSettings(Activity mainActivity, ArrayList<Chanel> chanels) {
