...
public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.SimpleViewHolder> {
    ...
    ArrayList<LiveChannels.Chanel> categories;
    ...
    public SimpleAdapter(Context context,ArrayList<LiveChannels.Chanel> categories) {
        mContext = context;
        ...
        holder.like_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!AppController.getInstance().getDatabaseHandler().is_following(categories.get(position).ch_id)){
                    ...
                    AppController.getInstance().getDatabaseHandler().addPlaylist(categories.get(position).ch_id,MainActivity.live_id,"0");
                   // holder.like_icon.setColorFilter(ContextCompat.getColor(mContext,R.color.aa_menu_text_selected));
                    holder.like_icon.setImageResource(R.drawable.live_tv_selected);
                }else{
                    ...
                    holder.like_icon.setImageResource(R.drawable.live_tv_unselected);
