...
public class News implements Parcelable {
    ...
    News(JSONObject jsonObject,Context context) {
        ...
        try {
          ...
          //  type = "add";
            ...
            chanels = new Chanel(jsonObject2,"1");
            facebook_str = decode_base64(jsonObject.getString("facebook_str"));
            twitter_str = decode_base64(jsonObject.getString("twitter_str"));
            whatsapp_str = decode_base64(jsonObject.getString("whatsapp_str"));
    ...
    News(JSONObject jsonObject, Context context,String video_news) {
        ...
        try {
            ...
            id = jsonObject.getString("id");
            image = jsonObject.getString("high");
            type = "news";
